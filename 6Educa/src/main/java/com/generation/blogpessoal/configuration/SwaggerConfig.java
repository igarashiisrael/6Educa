...
public class SwaggerConfig {
	...
	public OpenAPI springBlogPessoalOpenAPI() {
        ...
        return new OpenAPI()
				.info(new Info()
					.title("Projeto 6 EDUCA")
					.description("Projeto 6 EDUCA - Generation Brasil")
					.version("v0.0.1")
				.license(new License()
				...
				.contact(new Contact()
					.name("PROJETO 6EDUCA")
					.url("https://projetoseiseduca.herokuapp.com/")
					.email("6educa@gmail.com")))
				.externalDocs(new ExternalDocumentation()
					.description("Github - FRONTEND")
					.url("https://github.com/zRafael/6EducaFront")
				);
